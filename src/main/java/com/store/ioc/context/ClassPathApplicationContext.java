package com.store.ioc.context;

import com.store.ioc.domain.Bean;
import com.store.ioc.domain.BeanDefinition;
import com.store.ioc.exception.BeanNotFoundException;
import com.store.ioc.reader.BeanDefinitionReader;
import com.store.ioc.reader.XMLBeanDefinitionReader;
        ...
        for (BeanDefinition beanDefinition : beanDefinitionList) {
            if (beanDefinition.getValueDependencies() != null) {
                ...
                if(bean != null) {
                    ...
                    throw new BeanNotFoundException("Bean wasn't found!");
                }
            }
        }
    }
